export class InMemoryDataService {
    createDb() :any{
        let heroes = [
            ...
            {id: 21, name: 'Mr. Nice',age:100,placeOfResidence:"Berlin",favoriteWeapon:"Dagger"},
            {id: 22, name: 'Narco',age:200,placeOfResidence:"Saturn",favoriteWeapon:"Axt"},
            {id: 23, name: 'Bombasto',age:100,placeOfResidence:"Neptun",favoriteWeapon:"Handgun"},
            {id: 24, name: 'Celeritas',age:300,placeOfResidence:"Berlin",favoriteWeapon:"Spear"},
            {id: 25, name: 'Magneta',age:25,placeOfResidence:"NewYork",favoriteWeapon:"Sword"},
            {id: 26, name: 'RubberMan',age:20,placeOfResidence:"Berlin",favoriteWeapon:"Fire"},
            {id: 27, name: 'Dynama',age:500,placeOfResidence:"Mars",favoriteWeapon:"Handgun"},
            {id: 28, name: 'Dr IQ',age:100,placeOfResidence:"Berlin",favoriteWeapon:"Canon"},
            {id: 29, name: 'Magma',age:28,placeOfResidence:"Tokyo",favoriteWeapon:"Handgun"},
            {id: 30, name: 'Tornado',age:89,placeOfResidence:"Jupiter",favoriteWeapon:"Thunder"}
        ];
        return {heroes};
    }
}